    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'user-guides/training-videos/video-production-guide',
            'user-guides/training-videos/VIDEO_SCRIPTS_INDEX',
            'user-guides/training-videos/01-logging-in',
            'user-guides/training-videos/02-starting-table-session',
            'user-guides/training-videos/03-creating-order',
            'user-guides/training-videos/04-processing-payment',
            'user-guides/training-videos/05-split-payments',
          ],
        },
      ],
    },
