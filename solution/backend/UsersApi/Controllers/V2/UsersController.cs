...
/// <summary>
/// Version 2 Users Controller with RBAC enforcement
...
public class UsersController : ControllerBase
{
    ...
    /// <summary>
    /// Ping endpoint (no permission required for health checks)
    /// </summary>
    [HttpGet("ping")]
    ...
    /// <summary>
    /// Get all users (requires user:view permission)
    /// </summary>
    [HttpGet]
    ...
    /// </summary>
    [HttpPost]
    [RequiresPermission(Permissions.USER_CREATE)]
    ...
    /// </summary>
    [HttpPut("{userId}")]
    [RequiresPermission(Permissions.USER_UPDATE)]
    ...
    /// </summary>
    [HttpDelete("{userId}")]
    [RequiresPermission(Permissions.USER_DELETE)]
    ...
    /// <summary>
    /// Get user statistics (requires user:view permission)
    /// </summary>
    [HttpGet("stats")]
    [RequiresPermission(Permissions.USER_VIEW)]
    ...
    /// <summary>
    /// Validate credentials (no permission required - public endpoint)
    /// </summary>
    [HttpPost("validate")]
