param(
    ...
    [Parameter(Mandatory=$false)][string]$ServiceName = "magidesk-menu",
...
$SvcRoot = Join-Path $ScriptDir "MenuApi"
...
if ([string]::IsNullOrWhiteSpace($ServiceName)) { $ServiceName = "magidesk-menu" }
